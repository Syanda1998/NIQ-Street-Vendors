...
<form action="#" method="post" enctype="multipart/form-data" autocomplete="off">
    <p style="text-align: center; margin-top: 100px;"><img src="img/confirm.png" style="width:150px; height:150px;"></div></p>
    <div style="text-align: center;">
        <h2 style="text-align: center;"><?php echo "Are you sure you want to delete this record?" ?></h2>
        <p>
        </p>
