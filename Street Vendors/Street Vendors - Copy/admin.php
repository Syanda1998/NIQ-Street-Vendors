        ...
        <div id="page-content-wrapper">
            ...
            include "conn.php";
                    ...
                    if ($result-> num_rows > 0){	
                        echo "<table class='table bg-white rounded shadow-sm  table-hover' style='width: 97%; margin-left:20px;'>";
                        echo "<thead>";
                        echo "<tr>";
                ...
                <input type="paswword" class="input" name="password" placeholder="Password"></input>
                <label style="margin-top: 10px;"><b>Confirm Password</b></label>
                <input type="paswword" class="input" name="cpassword" placeholder="Confirm Password"></input>
