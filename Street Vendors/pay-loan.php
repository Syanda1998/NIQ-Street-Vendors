...
<div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4" style="margin-bottom:190px;">
            <div class="row my-5">
                <h3 class="fs-4 mb-3">Pay Loan</h3>
                <div class="content" style="border: 1px solid; width: 98%; margin-bottom: 10%; border-radius: 10px; margin-top: 5px;">
                <!-- --------------------------------DISPLAY ERROR AND SUCCESS MESSAGE-------------------------------- -->

                <?php if ($data == false) { ?>
                    <p class="error"><?php echo $msg ?></p>
                <?php } ?>
                <textarea type="text" rows="9" placeholder="<?php echo $text ?>" disabled style="width: 100%; margin-top: 10px;"></textarea>
